...
export const AlexpanByAnima = (): JSX.Element => {
  return (
        ...
        <div className="flex flex-col justify-between min-w-0 w-full">
          <div>
            ...
            <p className="text-[#383838] text-xs md:text-[15px] tracking-[-0.90px] text-justify mb-2 md:mb-4 break-words font-volkhov">
              Я всегда рад был работать с KinderShape, так как это позволяет нам использовать наши навыки в области образования и разработки программного обеспечения для детей.
            </p>
          </div>
          <div>
            <p className="text-[#383838] text-xs truncate font-volkhov">
              Москва | Россия | Программист
            </p>
